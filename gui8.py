...
class JsonViewer(QWidget):
    ...
    def init_ui(self):
        self.setWindowTitle('Word of the Day')
        ...
        # Set padding on the left and right sides
        self.layout.setContentsMargins(10, 0, 10, 0)

        # Set a fixed width for the window
        #self.setFixedWidth(800)
        # Set an initial width for the window on startup
        self.resize(1000, 300)

        # Enable word wrap for the QLabel
